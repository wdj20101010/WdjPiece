...
public class WdjPiece extends JFrame {
	...
	public WdjPiece() {
		...
		JMenuItem mntmNewMenuItem_5 = new JMenuItem("\u91CD\u7F6E");
		...
		mntmNewMenuItem_4.addActionListener(new ActionListener() {  //计算
			public void actionPerformed(ActionEvent e) {
				if(textArea.getText().indexOf("\n###RESULT###")!=-1)
					textArea.setText(textArea.getText().substring(0, textArea.getText().indexOf("\n###RESULT###")));
				try{
					WdjOperate wdj=new WdjOperate(textArea.getText());
					textArea.setText(textArea.getText()+wdj.结果);
					if(textArea.getText().indexOf("\n###RESULT###")!=-1)
		...
		mntmNewMenuItem_5.addActionListener(new ActionListener() {  //重置
			public void actionPerformed(ActionEvent e) {
				if(textArea.getText().indexOf("\n###RESULT###")!=-1)
					textArea.setText(textArea.getText().substring(0, textArea.getText().indexOf("\n###RESULT###")));
