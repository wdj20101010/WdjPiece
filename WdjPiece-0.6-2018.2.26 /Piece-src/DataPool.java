...
public class DataPool {
	...
	//执行队列
	private ArrayList<String> DPrunlist=new ArrayList<String>();
	String DPrun(){String str=null;
		if(DPrunlist.size()>0){str=DPrunlist.get(0);DPrunlist.remove(0);}
		return str;
	}
	void DPrunaddhead(ArrayList<String> runlist){DPrunlist.addAll(0, runlist);}
	void DPrunaddtail(ArrayList<String> runlist){DPrunlist.addAll(runlist);}
}
